...
fIonExciteEnergy(0.)
{
	...
	// create directory
	fDirectory = new G4UIdirectory("/medipix/gun/");
	...
	*/
	...
	// set particle  
	fParticleCmd = new G4UIcmdWithAString("/medipix/gun/particle", this);
	...
	// set the ion 
	fIonCmd = new G4UIcommand("/medipix/gun/ion", this);
	fIonCmd->SetGuidance("Set properties of ion to be generated.");
	fIonCmd->SetGuidance("usage: /medipix/gun/ion Z A Q E");
	...
	// number of primaries
	fPrimNbCmd = new G4UIcmdWithAnInteger("/medipix/gun/primaryNb", this);
	...
	// particle direction
	fDirectionCmd = new G4UIcmdWith3Vector("/medipix/gun/direction", this);
	fDirectionCmd->SetGuidance("Set momentum direction.");
	fDirectionCmd->SetGuidance("Direction needs not to be a unit vector.");
	fDirectionCmd->SetGuidance("usage: /medipix/gun/direction Px Py Pz");
	...
	// set polarization
	fPolarCmd = new G4UIcmdWith3Vector("/medipix/gun/polarization", this);
	fPolarCmd->SetGuidance("Set polarization vector.");
	fPolarCmd->SetGuidance("Direction needs not to be a unit vector.");
	fPolarCmd->SetGuidance("usage: /medipix/gun/polarization ex ey ez");
	...
	// particle energy
	fEnergyCmd = new G4UIcmdWithADoubleAndUnit("/medipix/gun/energy", this);
	fEnergyCmd->SetGuidance("Set the particle energy (default unit is MeV).");
	fEnergyCmd->SetGuidance("usage: /medipix/gun/energy E [unit]");
	...
	//Particle position
	fPositionCmd = new G4UIcmdWith3VectorAndUnit("/medipix/gun/position", this);
	fPositionCmd->SetGuidance("Set starting position of the particle(s) vertex (default unit is mm).");
	fPositionCmd->SetGuidance("usage: /medipix/gun/position X Y Z [unit]");
	...
	fTypeCmd = new G4UIcmdWithAString("/medipix/gun/sourceType", this);
	fTypeCmd->SetGuidance("Sets source distribution type.");
	fTypeCmd->SetGuidance("usage: /medipix/gun/sourceType DisType");
	...
	// source shape
	fShapeCmd = new G4UIcmdWithAString("/medipix/gun/shape", this);
	fShapeCmd->SetGuidance("Sets source shape type.");
	fShapeCmd->SetGuidance("usage: /medipix/gun/shape Shape");
	...
	// center coordinates
	fCenterCmd = new G4UIcmdWith3VectorAndUnit("/medipix/gun/center", this);
	...
	fCenterCmd->SetGuidance("usage: /medipix/gun/center X Y Z [unit]");
	...
	fHalfxCmd = new G4UIcmdWithADoubleAndUnit("/medipix/gun/halfx", this);
	...
	fHalfxCmd->SetGuidance("usage: /medipix/gun/halfx hx [unit]");
	...
	fHalfyCmd = new G4UIcmdWithADoubleAndUnit("/medipix/gun/halfy", this);
	...
	fHalfyCmd->SetGuidance("usage: /medipix/gun/halfy hy [unit]");
	...
	fHalfzCmd = new G4UIcmdWithADoubleAndUnit("/medipix/gun/halfz", this);
	...
	fHalfzCmd->SetGuidance("usage: /medipix/gun/halfz hz [unit]");
	...
	// radius of source  
	fRadiusCmd = new G4UIcmdWithADoubleAndUnit("/medipix/gun/radius", this);
	...
	fRadiusCmd->SetGuidance("usage: /medipix/gun/radius r [unit]");
	...
	// confine to volume(s)
	fConfineCmd = new G4UIcmdWithAString("/medipix/gun/confine", this);
	...
	fSurfNormCmd = new G4UIcmdWith3Vector("/medipix/gun/surfNorm", this);
	...
	fSurfNormCmd->SetGuidance("usage: /medipix/gun/surfNorm nx ny nz");
	...
	fAngTypeCmd = new G4UIcmdWithAString("/medipix/gun/angtype", this);
	...
	// verbosity
	fVerbosityCmd = new G4UIcmdWithAnInteger("/medipix/gun/verbose", this);
	...
	fGetPartCmd = new G4UIcmdWithoutParameter("/medipix/gun/getPartType", this);
	...
	fGetDirectCmd = new G4UIcmdWithoutParameter("/medipix/gun/getDirection", this);
	...
	fGetPolarCmd = new G4UIcmdWithoutParameter("/medipix/gun/getPolar", this);
